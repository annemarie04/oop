...
std::shared_ptr<Account> Account_factory::create_crypto_influencer(const std::string &username) {
    ...
    Photo p = pb
            ...
            .build();
    std::shared_ptr<Account> a = std::make_shared<Account>(username, 250000, 10, "crypto");
    a->add_photo(p);
    return a;
}
...
std::shared_ptr<Account> Account_factory::create_fashion_influencer(const std::string &username) {
    ...
    Live l = lb
            ...
            .ending_time(21)
            .build();
    std::shared_ptr<Account> a = std::make_shared<Account>(username, 250000, 12, "fashion");
    a->add_live(l);
    return a;
}
...
std::shared_ptr<Account> Account_factory::create_travel_influencer(const std::string &username) {
    ...
    Check_in c = cb
            ...
            .country("UAE")
            .build();
    std::shared_ptr<Account> a = std::make_shared<Account>(username, 213214, 2134, "travel");
    a->add_check_in(c);
    return a;
}
